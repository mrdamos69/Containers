...
class abstract_containers {
 ...
 public:
    ...
    size_t virtual max_size() = 0;  // возвращает максимально возможное количество элементов
...
class abstract_containers_list : public abstract_containers<T> {
 ...
 public:
    abstract_containers_list() : abstract_containers<T>(),
                                head(nullptr),
                                tail(nullptr) {}
};
...
class abstract_containers_arr : public abstract_containers<T> {
 protected:
        ...
        T *arr;
 public:
    abstract_containers_arr() : abstract_containers<T>(),
                                m_capacity(0),
                                arr(nullptr) {}
