...
TEST(Test_s21_set, s21_set_test_set_1) {
    ...
    {10, 5, 15, 3, 7, 13, 17, 6, 8, 2, 4, 16, 18, 12, 14, -1, 1, -5, 11};
    set<int> std_set_1
    {10, 5, 15, 3, 7, 13, 17, 6, 8, 2, 4, 16, 18, 12, 14, -1, 1, -5, 11};
...
TEST(Test_s21_set, s21_set_test_emplace_2) {
    s21::s21_set<int> s21_set_1
    {10, 5, 15, 3, 7, 13, 17, 6, 8, 2, 4, 16, 18, 12, 14, -1, 1, -5, 11};
    s21::s21_set<int> s21_set_2
    {10, 5, 15, 3, 7, 13, 17, 6, 8, 2, 4, 16, 18, 12, 14, -1, 1, -5, 11, 344, -25, 666};
...
TEST(Test_s21_map, s21_map_test_map_1) {
    s21::s21_map<int, char> s21_map_1
    {{5, '@'}, {3, '#'}, {7, '*'}, {2, '+'}, {4, '&'}, {6, ')'}, {8, '^'}};
    map<int, char> std_map_1
    {{5, '@'}, {3, '#'}, {7, '*'}, {2, '+'}, {4, '&'}, {6, ')'}, {8, '^'}};
...
TEST(Test_s21_map, s21_map_test_operator) {
    s21::s21_map<int, char> s21_map_1
    {{5, '@'}, {3, '#'}, {7, '*'}, {2, '+'}, {4, '&'}, {6, ')'}, {8, '^'}};
    s21::s21_map<int, char> s21_map_2
    {{10, '?'}, {5, '!'}, {15, '"'}, {3, ','}, {7, ':'}, {13, '-'}, {17, '='}};
    map<int, char> std_map_1
    {{5, '@'}, {3, '#'}, {7, '*'}, {2, '+'}, {4, '&'}, {6, ')'}, {8, '^'}};
    map<int, char> std_map_2
    {{10, '?'}, {5, '!'}, {15, '"'}, {3, ','}, {7, ':'}, {13, '-'}, {17, '='}};
    s21_map_1 = s21_map_2;
    std_map_1 = std_map_2;
    auto y = std_map_2.begin();
...
TEST(Test_s21_map, s21_map_test_emplace_1) {
    ...
    s21_map_1.emplace(std::pair<int, char> (88, '5'));
...
TEST(Test_s21_map, s21_map_test_emplace_2) {
    ...
    {{5, '@'}, {3, '#'}, {7, '*'}, {2, '+'}, {4, '&'}, {6, ')'}, {8, '^'}};
    map<int, char> std_map_1
    {{5, '@'}, {3, '#'}, {7, '*'}, {2, '+'}, {4, '&'}, {6, ')'}, {8, '^'}, {88, '5'}, {-66, '!'}};
    s21_map_1.emplace(std::pair<int, char> (88, '5'), std::pair<int, char> (-66, '!'));
...
TEST(Test_s21_multiset, s21_multiset_test_multiset_2) {
    s21::s21_multiset<int> s21_multiset_1
    {10, 5, 15, 3, 7, 3, 13, 17, 6, 8, 2, 4, 16, 18, 12, 14, 12, -1, 1, -5, 11};
    multiset<int> std_multiset_1
    {10, 5, 15, 3, 7, 3, 13, 17, 6, 8, 2, 4, 16, 18, 12, 14, 12, -1, 1, -5, 11};
...
TEST(Test_s21_set, s21_multiset_test_find_int) {
    s21::s21_multiset<int> s21_multiset_1 {5, 3, 3, 7, 2, 4, 6, 8, 6};
...
TEST(Test_s21_multiset, s21_multiset_test_emplace_2) {
    s21::s21_multiset<int> s21_multiset_1
    {10, 5, 15, 3, 7, 13, 17, 6, 8, 2, 4, 16, 18, 12, 14, -1, 1, -5, 11};
    s21::s21_multiset<int> s21_multiset_2
    {10, 5, 15, 3, 7, 13, 17, 6, 8, 2, 4, 16, 18, 12, 14, -1, 1, -5, 11, 344, -25, 666};
    s21_multiset_1.emplace(344, -25, 666);
